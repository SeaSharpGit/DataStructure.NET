...
namespace DataStructure.NET
{
    public class NoDirectionMatrix<T> : INoDirectionGraph<T>
    {
        ...
        public void SetEdge(MatrixNode<T> item, MatrixNode<T> item2)
        {
            ...
            if (_Relations[index, index2] == 1)
            {
                return;
            }
            _Relations[index, index2] = 1;
            _EdgeNum++;
        }
        ...
        public void DeleteEdge(MatrixNode<T> item, MatrixNode<T> item2)
        {
            ...
            if (_Relations[index, index2] == 0)
            {
                return;
            }
            _Relations[index, index2] = 0;
            _EdgeNum--;
        }
        ...
        public bool IsEdge(MatrixNode<T> item, MatrixNode<T> item2)
        {
            ...
            return _Relations[index, index2] == 1;
        }
    }
}
